...
from finrl.preprocessing.data_intraday import data_split
from finrl.env.env_stocktrading_intraday import StockTradingEnv
...
class DRLAgent:
    ...
    def DRL_prediction(model, environment):
        ...
        actions_memory = []
        test_env.reset()
        print(range(len(environment.df.index.unique())))
